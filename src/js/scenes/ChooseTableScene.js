...
export default class ChooseTableScene extends Phaser.Scene {
    ...
    CreateProfileSection() {
        ...
        this.userImage = this.add.image(this.userBase.x, this.userBase.y, "user_image").setOrigin(0.5).setScale(0.55);
        this.userRing = this.add.image(this.userBase.x, this.userBase.y, "user_ring").setOrigin(0.5).setScale(0.55);
        let userNameTextStyle = { fontFamily: "BAHNSCHRIFT", fontSize: '36px', fill: '#fff', fontStyle: 'normal', align: 'center' };
        this.userNameText = this.add.text(this.userBase.x + 150, this.userBase.y - 15, "Your Name", userNameTextStyle).setOrigin(0.5);
