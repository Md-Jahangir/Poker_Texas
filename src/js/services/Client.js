...
this.authToken = Model.GetAuthTokenFromLocalStorage();
        ...
        this.socket = io(this.baseUrl, {
            path: "/poker-engine-socket/socket.io",
            query: {
    ...
    //     this.authToken = Model.GetAuthTokenFromLocalStorage();//this.urlParams.get("authToken");
    //     this.tableId =Model.GetTableId();// this.urlParams.get("table_id");
    //     this.buyIn =Model.GetBuyInAmount();// this.urlParams.get("buyIn");
    //     this.maxPlayers =Model.GetMaxPlayersCount();// this.urlParams.get("max_players");
    //     this.smallBlind =Model.GetSmallBlindAmount();// this.urlParams.get("smallBlind");
    //     this.bigBlind =Model.GetBigBlindAmount();// this.urlParams.get("bigBlind");

    //     console.log("this.authToken: ",this.authToken);
    //     console.log("this.tableId: ",this.tableId);
    //     console.log("this.buyIn: ",this.buyIn);
    //     console.log("this.maxPlayers: ",this.maxPlayers);
    //     console.log("this.smallBlind: ",this.smallBlind);
    //     console.log("this.bigBlind: ",this.bigBlind);
    ...
    async SetConnection() {
        let data = {
            "authToken": Model.GetAuthTokenFromLocalStorage(),
        }
        console.log("SetConnection Model.GetAuthToken(): ", Model.GetAuthTokenFromLocalStorage());
    ...
    async JoinRoom() {
        ...
        console.log("Model.GetAuthToken(): ", Model.GetAuthTokenFromLocalStorage());
